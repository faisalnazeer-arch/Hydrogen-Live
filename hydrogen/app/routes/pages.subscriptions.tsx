          ...
          <div className="max-w-lg">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link to={page.heroCtaUrl}
                className="inline-flex items-center gap-2 rounded-lg bg-crimson px-7 py-3 text-sm font-bold uppercase tracking-wide shadow-lg transition-all hover:bg-rich-red" style={{ color: '#fff' }}>
