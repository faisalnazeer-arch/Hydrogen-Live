...
function ReelCard({ reel: r, onOpen }: { reel: ReelProduct; onOpen: () => void }) {
  ...
  return (
    <button
      ...
      className="group relative aspect-[9/16] w-[160px] flex-shrink-0 snap-start overflow-hidden rounded-xl bg-muted transition-transform hover:-translate-y-1 md:w-[220px]"
    >
      {/* Poster image */}
      {r.poster && (
        <img
