...
const SHOP_LINKS: FLink[] = [
  { label: "All Beef", to: "/collections/all-beef" },
  { label: "All Lamb", to: "/collections/all-lamb" },
  { label: "Australian Wagyu", to: "/collections/australian-wagyu-beef-mb-4-5" },
  { label: "Meat Boxes", to: "/collections/box-collection" },
  { label: "Build Your Box", to: "/collections/build-box" },
];
