...
export default hydrogenRoutes([
  ...
  route('ar/collections/:handle', 'routes/collections.$handle.tsx', { id: 'ar-collections' }),
  route('ar/products/:handle', 'routes/products.$handle.tsx', { id: 'ar-products' }),
  route('ar/search', 'routes/search.tsx', { id: 'ar-search' }),
  route('ar/blogs/all', 'routes/blogs.all.tsx', { id: 'ar-blogs-all' }),
  route('ar/blogs/:handle', 'routes/blogs.$handle.tsx', { id: 'ar-blogs' }),
