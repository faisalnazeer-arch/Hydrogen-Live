...
type Module = typeof import("../api.globo-options.$productId.js")

type Info = GetInfo<{
  file: "routes/api.globo-options.$productId.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.globo-options.$productId.js");
}];
